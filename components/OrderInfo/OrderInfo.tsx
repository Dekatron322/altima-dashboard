...
const OrderInfo = () => {
  return (
    <div className='flex border flex-col rounded-md '>
        <div className=' w-full flex  p-4 border-b gap-2'>
          <p className='text-lg font-medium'>Status</p>
          <div className="flex gap-1 items-center justify-center bg-[#FBF4EC] text-xs  text-[#D28E3D] rounded-full px-2 py-1">
      ...
      <div className='flex justify-between gap-3 p-4'>
              ...
              <div className='pr-3'>
                <ul className='my-2 border-t'>
                    ...
                    <li className='li__style mt-3'>Video Doorbell, Intercom System, Camera, Alexa Integration, Wi-Fi Connectivity, Battery Backupt</li>
              ...
              <p className='mt-2 li__style'>Reminder Sent on 26/12/2024 8:30am</p>
              </div>
          </div>
        </div>
