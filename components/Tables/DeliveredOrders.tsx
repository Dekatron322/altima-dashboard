...
const DeliveredOrders = () => {
  ...
  const [orders, setOrders] = useState<Order[]>([
    { orderId: "#ORD12345", customer: "Robert Fox", email: 'robertfox@example.com', phone: '(671) 555-0110', doorModel: "Alima Core", units: 200, payment30: "Paid", payment70: "Pending", orderStatus: "Delivered", date: "2024-12-19" },
    { orderId: "#ORD12346", customer: "Robert Lee", email: 'robertlee@example.com', phone: '(671) 855-0110', doorModel: "Alima Elite", units: 210, payment30: "Paid", payment70: "Paid", orderStatus: "Delivered", date: "2024-12-20" },
    { orderId: "#ORD12347", customer: "Robert Chang", email: 'robertchang@example.com', phone: '(671) 755-0110', doorModel: "Alima Core", units: 500, payment30: "Paid", payment70: "Pending", orderStatus: "Delivered", date: "2024-12-20" },
    ...
    { orderId: "#ORD12349", customer: "Robert Lee", email: 'robertfoxx@example.com', phone: '(671) 555-0111', doorModel: "Alima Core", units: 210, payment30: "Paid", payment70: "Pending", orderStatus: "Delivered", date: "2024-12-20" },
    { orderId: "#ORD12345", customer: "Robert Fox", email: 'robertfox@example.com', phone: '(671) 555-0110', doorModel: "Alima Core", units: 200, payment30: "Paid", payment70: "Pending", orderStatus: "Delivered", date: "2024-12-19" },
    { orderId: "#ORD12346", customer: "Robert Lee", email: 'robertlee@example.com', phone: '(671) 855-0110', doorModel: "Alima Elite", units: 210, payment30: "Paid", payment70: "Paid", orderStatus: "Delivered", date: "2024-12-20" },
    { orderId: "#ORD12347", customer: "Robert Chang", email: 'robertchang@example.com', phone: '(671) 755-0110', doorModel: "Alima Core", units: 500, payment30: "Paid", payment70: "Pending", orderStatus: "Delivered", date: "2024-12-20" },
    { orderId: "#ORD12348", customer: "Robert Lee", email: 'fox@example.com', phone: '(671) 565-0110', doorModel: "Alima Elite", units: 1200, payment30: "Paid", payment70: "Pending", orderStatus: "Delivered", date: "2024-12-20" },
