...
const AltimaEliteOrders = () => {
  ...
  const [orders, setOrders] = useState<Order[]>([
    { orderId: "#ORD12345", customer: "Robert Fox", email: 'robertfox@example.com', phone: '(671) 555-0110', doorModel: "Alima Elite", units: 200, payment30: "Paid", payment70: "Pending", orderStatus: "Confirmed", date: "2024-12-19" },
    ...
    { orderId: "#ORD12347", customer: "Robert Chang", email: 'robertchang@example.com', phone: '(671) 755-0110', doorModel: "Alima Elite", units: 500, payment30: "Paid", payment70: "Not Paid", orderStatus: "Cancelled", date: "2024-12-20" },
    { orderId: "#ORD12348", customer: "Robert Lee", email: 'fox@example.com', phone: '(671) 565-0110', doorModel: "Alima Elite", units: 1200, payment30: "Paid", payment70: "Pending", orderStatus: "Pending", date: "2024-12-20" },
    { orderId: "#ORD12349", customer: "Robert Lee", email: 'robertfoxx@example.com', phone: '(671) 555-0111', doorModel: "Alima Elite", units: 210, payment30: "Paid", payment70: "Pending", orderStatus: "Confirmed", date: "2024-12-20" },
    { orderId: "#ORD12345", customer: "Robert Fox", email: 'robertfox@example.com', phone: '(671) 555-0110', doorModel: "Alima Elite", units: 200, payment30: "Paid", payment70: "Pending", orderStatus: "Completed", date: "2024-12-19" },
    { orderId: "#ORD12346", customer: "Robert Lee", email: 'robertlee@example.com', phone: '(671) 855-0110', doorModel: "Alima Elite", units: 210, payment30: "Paid", payment70: "Paid", orderStatus: "Cancelled", date: "2024-12-20" },
    { orderId: "#ORD12347", customer: "Robert Chang", email: 'robertchang@example.com', phone: '(671) 755-0110', doorModel: "Alima Elite", units: 500, payment30: "Paid", payment70: "Not Paid", orderStatus: "Pending", date: "2024-12-20" },
    { orderId: "#ORD12348", customer: "Robert Lee", email: 'fox@example.com', phone: '(671) 565-0110', doorModel: "Alima Elite", units: 1200, payment30: "Paid", payment70: "Pending", orderStatus: "Confirmed", date: "2024-12-20" },
    { orderId: "#ORD12349", customer: "Robert Lee", email: 'robertfoxx@example.com', phone: '(671) 555-0111', doorModel: "Alima Elite", units: 210, payment30: "Paid", payment70: "Pending", orderStatus: "Confirmed", date: "2024-12-20" },
  ]);
  ...
  return (
    ...
    <div className="w-full overflow-x-auto border">
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <p>show rows</p>
        <select value={rowsPerPage} onChange={handleRowsChange} className='p-1 select__rows'>
