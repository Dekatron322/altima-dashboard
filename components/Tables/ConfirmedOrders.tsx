...
const ConfirmedOrders = () => {
  ...
  const [orders, setOrders] = useState<Order[]>([
    ...
    { orderId: "#ORD12346", customer: "Robert Lee", email: 'robertlee@example.com', phone: '(671) 855-0110', doorModel: "Alima Elite", units: 210, payment30: "Paid", payment70: "Paid", orderStatus: "Confirmed", date: "2024-12-20" },
    { orderId: "#ORD12347", customer: "Robert Chang", email: 'robertchang@example.com', phone: '(671) 755-0110', doorModel: "Alima Core", units: 500, payment30: "Paid", payment70: "Not Paid", orderStatus: "Confirmed", date: "2024-12-20" },
